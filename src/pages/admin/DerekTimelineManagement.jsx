...
function DerekTimelineManagement() {
  ...
  const handleAddEvent = async () => {
    ...
    if (error) {
      console.error(error);
      alert("Failed to add Derek timeline event.");
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-[#080a0f] text-white p-8">
      <div className="max-w-7xl mx-auto bg-[#101118] min-h-[850px]">
        ...
        <section className="p-8 grid lg:grid-cols-[1fr_360px] gap-8">
          ...
          <aside className="space-y-6">
            <Panel title="Add Derek Timeline Event">
              <Field
                label="Year / Date"
                placeholder="2026"
      ...
      <ConfirmModal
        ...
        title="Delete Derek Timeline Event?"
...
export default DerekTimelineManagement;